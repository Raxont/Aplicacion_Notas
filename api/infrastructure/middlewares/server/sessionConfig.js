import session from 'express-session'// Importa el middleware de sesiones para Express
process.loadEnvFile();
...
export default sessionConfig; // Exporta la configuración de sesión para su uso en otros módulos
